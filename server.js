...
// MOTOR ULTRA-RÁPIDO: Configurado para resposta em menos de 15-35s
const config = { 
  lang: "por", 
  oem: 3, 
  psm: 6,
...
app.post('/analisar-fluxo', upload.single('print'), async (req, res) => {
  try {
    ...
    // RESTAURAÇÃO COMPLETA DA TENDÊNCIA
    ...
    if (gapRosa >= 60) {
        ...
        pct = "81%"; // Mínimo de 80%+ solicitado
    }

    // AJUSTE DE HORA E MINUTO (Sincronização Luanda)
